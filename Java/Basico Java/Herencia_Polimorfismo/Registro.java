    ...
    public static void main(String[] args) throws Exception {
        ...
        do {
                ...
                /*  String estudiante = division[1];
                 ...
                 cantidadCreditos = Integer.parseInt(division[6]);
                 } else if (estudiante.equals("Posgrado")) {
                 modalidad = division[6];
                 }
                 Estudiante e = new Estudiante(nombre, edad, programa, etnia);
                 Estudiante e1 = new Pregrado(nombre, edad, programa, etnia,
                 cantidadCreditos);
                 Estudiante e2 = new Posgrado(nombre, edad, programa, etnia, modalidad);
